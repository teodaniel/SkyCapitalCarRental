...
public final class CarRepository {
    ...
    public static List<CarModel> getCars() {
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_bmw_4_series_gran_coupe_l,
                "Petrol", "Automatic", 2.0,
                5, 3,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_byd_atto_3_2024_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_daihatsu_move_2025_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_ford_bronco_1_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_ford_mustang_2024_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_honda_fit_2024_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_honda_freed_2024_l,
                "Hybrid", "Automatic", 1.5,
                7, 3,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_honda_freed_2_new_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_honda_n_box_2_l,
                "Petrol", "Automatic", 0.66,
                4, 1,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_honda_n_box_white_l,
                "Petrol", "Automatic", 0.66,
                4, 1,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_honda_odyssey_2023_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_honda_spike_1_l,
                "Petrol", "Automatic", 1.5,
                5, 3,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_honda_stepwagon_new_l,
                "Hybrid", "Automatic", 1.5,
                8, 4,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_honda_vezel_2024_l,
                "Hybrid", "Automatic", 1.5,
                5, 2,
                Arrays.asList("Bluetooth", "GPS", "Backup Camera", "Apple CarPlay", "Cruise Control"), 4.7,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_mazda6_atenza_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_mazda_biante_new_l,
                "Petrol", "Automatic", 2.0,
                8, 3,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_mazda_cx5_2013_l,
                "Diesel", "Automatic", 2.2,
                5, 3,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_mazda_cx_3_2021_l,
                "Petrol", "Automatic", 2.0,
                5, 2,
                Arrays.asList("Bluetooth", "GPS", "Backup Camera", "Apple CarPlay"), 4.5,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_mazda_cx_5_2024_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_mazda_premacy_2019_l,
                "Petrol", "Automatic", 2.0,
                7, 3,
                Arrays.asList("Bluetooth", "GPS", "Backup Camera", "Sliding Doors"), 4.5,
                50.0, 200.0, "Full to Full",
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_mercedes_benz_b_class_1_l,
        ...
        cars.add(new CarModel(
                ...
                R.drawable.car_mercedes_benz_sl_class_l,
